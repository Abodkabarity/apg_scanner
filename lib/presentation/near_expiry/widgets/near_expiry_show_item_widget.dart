...
class NearExpiryShowItemsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<NearExpiryBloc, NearExpiryState>(
      listenWhen: (prev, curr) =>
          prev.productsRevision != curr.productsRevision,
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          onTap: () async {
                            ...
                            final product = bloc.productsRepo.products
                                .firstWhere(
